...
from . xpd54_cyberoamconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('xpd54-cyberoam')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('xpd54_cyberoam_lib')
